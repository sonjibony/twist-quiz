...
const Blog = () => {
  return (
    // BLOG QUESTION AND ANSWER ADDED

    <div className="blog-container">
      <div className="blog-intro">
        <h1 className="greet">Welcome!</h1>
        <p className="tag-line">
          I hope you find what you're looking for and that you enjoy your stay.
        </p>
      </div>
      ...
      <div className="use-ref">
        <div className="ques-ans">
          <h2 className="ques">
            2.What is useRef Hook and its functionalities?
          </h2>
          <p className="ans">
            ...
            mutable ref object it returns will persist for the full lifetime of
            the component.
          </p>
        </div>
        <img
          src={
            "https://res.cloudinary.com/practicaldev/image/fetch/s--fBV9Brp0--/c_imagga_scale,f_auto,fl_progressive,h_900,q_auto,w_1600/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/qnwi8ehe64zysba5y195.png"
          }
          alt=""
        ></img>
      </div>
      ...
      <div className="context-api">
        <img
          src={
            "https://www.loginradius.com/blog/static/157af7ff069ab273224b4718433d9790/03979/title-image.png"
          }
          alt=""
        ></img>
        <div className="ques-ans">
          ...
          <p className="ans">
            ...
            child to parent, and so on.For example, some use cases the Context
            API is ideal for: theming, user language, authentication, etc
          </p>
        </div>
      </div>
    </div>
